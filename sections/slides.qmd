...
![](images/garnier-tee.png){width=60%}
Figure from [Garnier & Pavoine _et al._,2025](https://doi.org/10.1016/j.tree.2025.06.004)
:::
...
{{< fa circle-right>}} &nbsp;What kind of **data** / **metadata** are you using for your research?
...
::: {.column width=33%}
![](images/postit.png){width=60% fig-align="center"}
:::
...
{{< fa circle-right>}} &nbsp;How would you classify data?
...
- [PNDB Data Access](https://www.pndb.fr/explore) 

- [PNDB Services](https://www.pndb.fr/pages/galaxy-ecology0/)

- [PNDB Resources](https://www.pndb.fr/fr/ressources/ressources-en-ecoinformatique)

- [PNDB Bibliographic resources](https://pndb.opendatasoft.com/explore/?orderBy=updated_at+DESC&refines=keywords%3ABibliographie&refines=category%3ARessources)

- [THEIA Data Access](https://catalogue.theia.data-terra.org/)

- [Data Terra Tools and services](https://www.data-terra.org/donnees-services/acces-rapide/)

![](images/image-logo-dataterra2025.jpg){width=50%}
![](images/image-logo-pndb.jpg){width=25%}
![](images/image-logo-theia.png){width=25%}
:::
