...
<br/>
[Ouvrir la science (2024)](https://www.ouvrirlascience.fr/selectionner-un-entrepot-thematique-de-confiance-pour-le-depot-de-donnees-methodologie-et-analyse-de-loffre-existante/)[^12]
:::
...
**Examples of trusted thematic repositories**

| Repositories names    |  Supporting institutions   | thematic and/or institutional and/or Generic | disciplinary fields    | Accepted data: keywords that speak to the community    | Volume limit    |
|:------------|:-----------:|------------:|------------:|------------:|------------:|
| data.InDoRES | CNRS-Ecology, MNHN | Thematic, institutional | Ecology, Environment, Bio-archaeology | Row 1 Col 5 | Row 1 Col 6 |
| EaSy Data | Data Terra, BRGM | Thematic, institutional | Earth and Environmental Sciences | Row 2 Col 5 | Row 2 Col 6 |
| Data Sud | Row 3 Col 2 | Row 3 Col 3 | Row 3 Col 4 | Row 3 Col 5 | Row 3 Col 6 |
| SEANOE | Row 4 Col 2 | Row 4 Col 3 | Row 4 Col 4 | Row 4 Col 5 | Row 4 Col 6 |
| GBIF | Row 4 Col 2 | Row 4 Col 3 | Row 4 Col 4 | Row 4 Col 5 | Row 4 Col 6 |
...
[^12] : This note - produced by the Research Data College - proposes a method for identifying thematic repositories based on the exclusion and description criteria of the repositories. This is accompanied by an initial list resulting from the grid of analysis criteria selected.
...
::: {.column .center width=33%}
![](images/image_DataMetadata.png){width=120%}
:::
...
- [web page](https://recherche.data.gouv.fr/fr)

- [trainings](https://recherche.data.gouv.fr/fr/page/classes-virtuelles)
